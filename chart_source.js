var margin = {top: 20, right: 40, bottom: 10, left: 40},
    ...
    d3.csv("count_s.csv", function(data) {
      Allcount = data;
    ...
    function render(data) {
      ...
      svg2.selectAll(".circleGroup")
          ...
          .enter()
            .append("g")
              ...
              .attr("transform", function(d) { return "translate(0," + (y(d.Type) + height) + ")"; })
      ...
      svg2.selectAll(".circleGroup")
          .data(data, function(d) { return d.Type; })
            .transition()
            .duration(2000)
            .attr("transform", function(d) { return "translate(0," + (d.y0 = y(d.Type)) + ")"; })
